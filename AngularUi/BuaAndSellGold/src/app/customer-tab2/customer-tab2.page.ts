...
@Component({
  ...
  standalone: true,
  imports: [ReactiveFormsModule, IonContent, IonHeader, IonTitle, IonToolbar, CommonModule, FormsModule,
    IonModal,
    IonAvatar,
    IonButton,
    IonButtons,
...
export class CustomerTab2Page implements OnInit {
  ...
  ngOnInit() {
    ...
    // console.log("recived_id _______ ", this.recived_id);

    // const sellerId: number = Number(localStorage.getItem('seller_id'));

    // console.log("sellerId _______ ", sellerId);
