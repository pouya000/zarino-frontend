...
export class LoginPage implements OnInit {
        ...
        .subscribe((result: any) => {
          ...
          if (result.jwt && result['user']['user_type'] == 'seller') {
            localStorage.setItem('seller_id', result.user.seller_id);
             this.userservice.userSubject.next(result['user']);
  ...
  async onSelectSellerFirstTimeSubmit() {
    ...
    const resultRegister = await this.userservice.createCustomer(this.selectSellerForm.value).subscribe(
      (response: any) => {
